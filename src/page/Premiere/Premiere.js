      ...
      <div className="bg-[#f5f5f9] pt-10 pb-10">
        <div className="container px-48 mx-auto">
          ...
          <div className="flex items-center justify-center gap-5 mt-5">
            <video src="https://nahalit.com/wp-content/uploads/2022/10/before-after.mp4" width={537} controls />
            <video src="https://nahalit.com/wp-content/uploads/2022/10/Untitled.mp4" width={537} controls />
          </div>
          <div className="flex items-center justify-center flex-wrap gap-5 mt-5">
            <div>
              <iframe
                className="w-[22rem] h-[12.3rem]"
                title="movie"
