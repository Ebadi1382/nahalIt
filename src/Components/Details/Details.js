...
const Details = () => {
  return (
    <div className="flex items-center justify-center gap-x-4 container px-48 max-xl:px-20 max-xl:flex-wrap max-lg:px-0 mx-auto mb-96 ">
      <div className="w-[23rem] max-xl:mb-80">
        <div className="relative">
          ...
          />
          <div className="bg-[#e3e3e3] min-w-full h-[23rem] absolute top-[18rem] flex items-end justify-start">
          ...
          <div className="max-w-[90%] flex flex-col items-start p-6 justify-center bg-white absolute top-[15rem] left-[1.05rem]">
            ...
            <button className="bg-[#56C253] hover:bg-[#4dce49] rounded-lg transition-all duration-200 py-2 px-24 max-2xl:px-10 mx-auto whitespace-nowrap text-white tracking-tight font-semibold">
              بیشتر بخوانید...
            </button>
          </div>
        </div>
