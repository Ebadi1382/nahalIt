...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className=" 2xl:container md:px-0 lg:px-10 2xl:px-48 mx-auto">
        <div className="flex justify-start mt-3 text-center mx-auto gap-x-20">
        ...
        <div className="flex justify-between mt-1">
          <div className="text-[#7c7c7c] text-sm flex gap-x-10 lg:gap-x-5">
            <ul className="flex justify-start items-center gap-x-4 lg:whitespace-nowrap">
              <li>
            ...
            <div className="flex items-center justify-center xl:gap-x-3 lg:gap-x-1">
              <div className="bg-[#57C053] hover:bg-[#62d15e] transition-all duration-300 text-white flex flex-row-reverse px-4 py-3 rounded-md items-center justify-center gap-x-2">
                <Link>
                  <p className="text-md font-[shabnamMedium] tracking-tight">فروشنده باشید</p>
                </Link>
                <FaSpa className="text-xl" />
              </div>
              <div className="flex flex-row-reverse items-center justify-center py-3 px-3 rounded-md bg-[#57C053] hover:bg-[#62d15e] text-white gap-x-2">
                <Link>
            ...
            <div className="flex items-center justify-start gap-x-5">
              <div className="relative" onMouseEnter={clickEntershowslide4} onMouseLeave={clickoutshowslide4}>
                ...
                <div
                  ...
                  className={
                    showSlide4
                      ? "container bg-white w-96 px-5 mx-auto absolute shadow-[1px_1px_10px_rgba(0,0,0,.25)] py-6 top-12 -right-[23rem] transition-all duration-700"
                      : "container bg-white w-96 px-5 mx-auto absolute opacity-0 -right-[23rem] -translate-y-[50rem] transition-all duration-700"
                  }
                >
              ...
              <div className="flex relative" onMouseEnter={clickEntershowslide5} onMouseLeave={clickoutshowslide5}>
                ...
                <div
                  className={
                    showSlide5
                      ? "container bg-white flex flex-col justify-around w-80 h-28 px-5 mx-auto absolute shadow-[1px_1px_10px_rgba(0,0,0,.25)] top-10 -right-[19rem] transition-all duration-700"
                      : "container bg-white w-80 h-28 px-5 mx-auto absolute opacity-0 -right-[19rem] -translate-y-[50rem] top-10 transition-all duration-700"
                  }
                >
